// Code generated by protoc-gen-go-counters_grpc. DO NOT EDIT.
// versions:
// - protoc-gen-go-counters_grpc v1.2.0
// - protoc             v4.24.0--rc3
...
// is compatible with the counters_grpc package it is being compiled against.
...
func (c *raftNodeClient) RequestVote(ctx context.Context, in *RequestVoteRequest, opts ...grpc.CallOption) (*RequestVoteResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/counters_grpc.RaftNode/RequestVote", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *raftNodeClient) AppendEntries(ctx context.Context, in *AppendEntriesRequest, opts ...grpc.CallOption) (*AppendEntriesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/counters_grpc.RaftNode/AppendEntries", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _RaftNode_RequestVote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/counters_grpc.RaftNode/RequestVote",
	}
...
func _RaftNode_AppendEntries_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/counters_grpc.RaftNode/AppendEntries",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
// It's only intended for direct use with counters_grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var RaftNode_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "counters_grpc.RaftNode",
	...
	Metadata: "raft_node.counters_grpc",
}
